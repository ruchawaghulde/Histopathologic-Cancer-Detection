...
import os
import shutil
print(os.listdir("C:/Users/Shruti/Desktop"))
...
base_tile_dir = 'C:/Users/Shruti/Desktop/train'
df = pd.DataFrame({'path': glob(os.path.join(base_tile_dir,'*.tif'))})
df['id'] = df.path.map(lambda x: x.split('/')[3].split(".")[0])
labels = pd.read_csv("C:/Users/Shruti/Desktop/train_labels.csv")
...
# Create directories
train_path = 'C:/Users/Shruti/Desktop/train'
valid_path = 'C:/Users/Shruti/Desktop/valid'
test_path = 'C:/Users/Shruti/Desktop/test'
...
for image in df_train['id'].values:
    ...
    src = os.path.join('C:/Users/Shruti/Desktop/train', fname)
...
base_test_dir = 'C:/Users/Shruti/Desktop/test/'
...
submission.to_csv("SubmissionTwo.csv", index = False, header = True)
